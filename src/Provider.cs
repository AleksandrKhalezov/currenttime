...
namespace Microframework
{
    ...
    class Provider
    {
        ...
        public void Open(string url, TimeSpan time)
        {
            ...
            testTime.Stop();        
            result = new TestResults(time>=testTime.Elapsed, command.commandString, testTime.Elapsed);
        ...
        public void CheckLinkPresenrByHref(string href)
        {
            ...
            testTime.Stop();
            result = new TestResults(isExist, command.commandString, testTime.Elapsed);
            logger.results.Add(result);
        }
         ...
         public void CheckContains(string text)
        {
            ...
            testTime.Stop();
            result = new TestResults(isContains, command.commandString, testTime.Elapsed);
            logger.results.Add(result);
        }
        ...
        public void CheckPageTitle(string title)
        {
           ...
           testTime.Stop();
           result = new TestResults(isCorrect, command.commandString, testTime.Elapsed);
           logger.results.Add(result);
        }
    }
}